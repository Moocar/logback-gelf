...
public class GelfConverter<E> {
    ...
    public GelfConverter(String facility, boolean useLoggerName,
	    boolean useThreadName, Map<String, String> additionalFields,
	    int shortMessageLength, String hostname) {
	...
	double logEventTimeTimeStamp = ((ILoggingEvent) logEvent)
		.getTimeStamp() / 1000.0;
     ...
     */
    private void additionalFields(Map<String, Object> map,
